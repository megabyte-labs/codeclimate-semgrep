<!-- ⚠️ This README has been generated from the file(s) ".config/docs/blueprint-readme-codeclimate.md" ⚠️--><div align="center">
  <center>
    <a href="https://github.com/megabyte-labs/codeclimate-semgrep">
      <img width="148" height="148" alt="Semgrep logo" src="https://gitlab.com/megabyte-labs/docker/codeclimate/semgrep/-/raw/master/logo.png" />
    </a>
  </center>
</div>
<div align="center">
  <center><h1 align="center"><i></i>Semgrep CodeClimate Engine<i></i></h1></center>
...
<div align="center">
  ...
  <a href="https://github.com/megabyte-labs/codeclimate-semgrep/blob/master/docs/CONTRIBUTING.md" title="Learn about contributing" target="_blank">
  ...
  <a href="https://github.com/megabyte-labs/codeclimate-semgrep" title="GitHub mirror" target="_blank">
    <img alt="GitHub" src="https://img.shields.io/badge/Mirror-GitHub-333333?logo=github&style=for-the-badge" />
  </a>
  <a href="https://gitlab.com/megabyte-labs/docker/codeclimate/semgrep" title="GitLab repository" target="_blank">
    <img alt="GitLab" src="https://img.shields.io/badge/Repo-GitLab-fc6d26?logo=data:image/png;base64,&style=for-the-badge" />
  </a>
</div>
<br/>
<div align="center">
  <a title="Version: pkg.version" href="https://github.com/megabyte-labs/codeclimate-semgrep" target="_blank">
  ...
  <a title="DockerHub image size" href="https://hub.docker.com/repository/docker/megabytelabs/semgrep" target="_blank">
    <img alt="Image size" src="https://img.shields.io/docker/image-size/megabytelabs/semgrep?logo=docker&sort=date&logoColor=white&style=flat-square">
  </a>
  <a title="DockerHub pulls" href="https://hub.docker.com/repository/docker/megabytelabs/semgrep" target="_blank">
    <img alt="Pulls" src="https://img.shields.io/docker/pulls/megabytelabs/semgrep?logo=docker&logoColor=white&style=flat-square">
  </a>
  <a title="DockerHub stars" href="https://hub.docker.com/repository/docker/megabytelabs/semgrep" target="_blank">
    <img alt="Stars" src="https://img.shields.io/docker/stars/megabytelabs/semgrep?logo=docker&logoColor=white&style=flat-square">
  </a>
  <a title="Documentation" href="https://megabyte.space/docs/docker" target="_blank">
    <img alt="Documentation" src="https://img.shields.io/badge/documentation-yes-brightgreen.svg?logo=readthedocs&logoColor=white&style=flat-square" />
  </a>
  <a title="License: MIT" href="https://github.com/megabyte-labs/codeclimate-semgrep/blob/master/LICENSE" target="_blank">
    <img alt="License: MIT" src="https://img.shields.io/badge/license-MIT-yellow.svg?logo=data:image/png;base64,&style=flat-square" />
  </a>
</div>

> </br><h4 align="center">**A Semgrep slim container and a CodeClimate engine container for GitLab CI**</h4></br>
...
This project is the home of a [Semgrep](https://semgrep.dev/) [CodeClimate](https://codeclimate.com/) engine. It was built to integrate Semgrep results into the GitLab merge request web UI. This project builds multiple types of containers. It builds a CodeClimate engine and a standalone linter. Both of these types are available as slim builds.
...
```shell
docker run -it -v ${PWD}:/work -w /work --rm megabytelabs/semgrep:latest --help
```

This allows you to run Semgrep without installing it locally. It also removes the image from your system when you are done. This could be good for security since the application is within a container and also keeps your file system clean.

You can also add a bash alias to your `~/.bashrc` file so that you can run the Semgrep command at any time. To do this, add the following snippet to your `~/.profile` file (or equivalent):

```shell
semgrep() {
  docker run -it -v ${PWD}:/work -w /work --rm megabytelabs/semgrep:latest "$@"
}
```
...
```shell
docker pull megabytelabs/codeclimate-semgrep:latest
docker tag megabytelabs/codeclimate-semgrep:latest codeclimate/codeclimate-semgrep:latest
```
...
include:
  - remote: https://gitlab.com/megabyte-labs/gitlab-ci/-/raw/master/lint/semgrep.gitlab-ci.yml
```
...
docker build --pull -t "$DOCKERHUB_USERNAME/semgrep:latest" .
docker push "$DOCKERHUB_USERNAME/semgrep:latest"
```
...
export DOCKERHUB_PASSWORD=Your_DockerHub_Password_Here
docker login -u "$DOCKERHUB_USERNAME" -p "$DOCKERHUB_PASSWORD" docker.io
docker build -t "$DOCKERHUB_USERNAME/semgrep:latest" .
docker-slim build --tag $DOCKERHUB_USERNAME/semgrep:slim {{#if (eq (typeOf dockerSlimCommand) "string")}}dockerSlimCommand}}{{/if{{#if (not (eq (typeOf dockerSlimCommand) "string"))}}dockerSlimCommand[slug]}}{{/if $DOCKERHUB_USERNAME/semgrep:latest
docker push "$DOCKERHUB_USERNAME/semgrep:slim"
```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/megabyte-labs/codeclimate-semgrep/issues). If you would like to contribute, please take a look at the [contributing guide](https://github.com/megabyte-labs/codeclimate-semgrep/blob/master/docs/CONTRIBUTING.md).
...
Copyright © 2020-2021 [Megabyte LLC](https://megabyte.space). This project is [MIT](https://gitlab.com/megabyte-labs/docker/codeclimate/semgrep/-/blob/master/LICENSE) licensed.
